...
Filter_724_802 = function(input_data_724_802) {
  ...
  for (i in 1:ncol(my_data)) {
    if (grepl("W_C_*", colnames(my_data)[i])) {
      ...
      my_data[(nrow(my_data)), i] <- "WC"
      
      # GA and CK
    } else if (grepl("GA3_CK_C_*", colnames(my_data)[i])) {
      my_data[(nrow(my_data) - 1),i] <- "Reference"
      my_data[(nrow(my_data)), i] <- "GA3_CKC"
    } else if (grepl("GA3_[^CK_C]", colnames(my_data)[i])) {
      my_data[(nrow(my_data) - 1),i] <- "T_GA" 
      my_data[(nrow(my_data)), i] <- "GA3" 
     
      # AUX 
    } else if (grepl("AUX_C_", colnames(my_data)[i])) {
      my_data[(nrow(my_data) - 1),i] <- "AUX_C"
      my_data[(nrow(my_data)), i] <- "AUXC"
    } else if (grepl("AUX_[^C]", colnames(my_data)[i])) {
      my_data[(nrow(my_data) - 1),i] <- "AUX_no_C"
      my_data[(nrow(my_data)), i] <- "AUX"
      
      # CK
    } else if (grepl("^CK_", colnames(my_data)[i])) {
      my_data[(nrow(my_data) - 1),i] <- "NonReference" 
      my_data[(nrow(my_data)), i] <- "CK"
    } 
  }
...
Filter_809 = function(input_data_809) {
  ...
  for (i in 1:ncol(my_data)) {
    ...
    my_data[(nrow(my_data)), i] <- "SBC"
  } else if (grepl("SB\\.CK(.*?)G", colnames(my_data)[i])) {
    my_data[(nrow(my_data) - 2),i] <- "C_Untransformed"
    my_data[(nrow(my_data) - 1), i] <- "Control_Region"
    my_data[(nrow(my_data)), i] <- "SBCK"
  
    # DPR1   
  } else if (grepl("DPR\\.1(.*?)G_S", colnames(my_data)[i])) {
    my_data[(nrow(my_data) - 2),i] <- "T_Transformed"
    my_data[(nrow(my_data) - 1), i] <- "Empty_Vector"
    my_data[(nrow(my_data)), i] <- "DPR1_Gall"
  } else if (grepl("DPR\\.1(.*?)[^G]_S*", colnames(my_data)[i])) {
    my_data[(nrow(my_data) - 2),i] <- "T_Transformed"
    my_data[(nrow(my_data) - 1), i] <- "Empty_Vector"
    my_data[(nrow(my_data)), i] <- "DPR1_NoGall"
    
    # DPR2   
  } else if (grepl("DPR\\.2(.*?)G_S", colnames(my_data)[i])) {
    my_data[(nrow(my_data) - 2),i] <- "T_Transformed"
    my_data[(nrow(my_data) - 1), i] <- "Empty_Vector"
    my_data[(nrow(my_data)), i] <- "DPR2_Gall"
  } else if (grepl("DPR\\.2(.*?)[^G]_S*", colnames(my_data)[i])) {
    my_data[(nrow(my_data) - 2),i] <- "T_Transformed"
    my_data[(nrow(my_data) - 1), i] <- "Empty_Vector"
    my_data[(nrow(my_data)), i] <- "DPR2_NoGall"
    
    # WUS Reg 1
  } else if (grepl("X1(.*?)G_S", colnames(my_data)[i])) {
    my_data[(nrow(my_data) - 2),i] <- "T_Transformed"
    my_data[(nrow(my_data) - 1), i] <- "WUS_Reg_1"
    my_data[(nrow(my_data)), i] <- "WUS_Reg1_Gall"
  } else if (grepl("X1(.*?)[^G]_S", colnames(my_data)[i])) {
    my_data[(nrow(my_data) - 2),i] <- "T_Transformed"
    my_data[(nrow(my_data) - 1), i] <- "WUS_Reg_1"
    my_data[(nrow(my_data)), i] <- "WUS_Reg1_NoGall"

    # WUS Reg 2
  } else if (grepl("X2(.*?)G_S", colnames(my_data)[i])) {
    my_data[(nrow(my_data) - 2),i] <- "T_Transformed"
    my_data[(nrow(my_data) - 1), i] <- "WUS_Reg_2"
    my_data[(nrow(my_data)), i] <- "WUS_Reg2_Gall"
  } else if (grepl("X2(.*?)[^G]_S", colnames(my_data)[i])) {
    my_data[(nrow(my_data) - 2),i] <- "T_Transformed"
    my_data[(nrow(my_data) - 1), i] <- "WUS_Reg_2"
    my_data[(nrow(my_data)), i] <- "WUS_Reg2_NoGall"
  
    # LFY Reg 1 
  } else if (grepl("X3(.*?)G_S", colnames(my_data)[i])) {
    my_data[(nrow(my_data) - 2),i] <- "T_Transformed"
    my_data[(nrow(my_data) - 1), i] <- "LFY_Reg_1"
    my_data[(nrow(my_data)), i] <- "LFY_Reg1_Gall"
  } else if (grepl("X3(.*?)[^G]_S", colnames(my_data)[i])) {
    my_data[(nrow(my_data) - 2),i] <- "T_Transformed"
    my_data[(nrow(my_data) - 1), i] <- "LFY_Reg_1"
    my_data[(nrow(my_data)), i] <- "LFY_Reg1_NoGall"
    
    # LFY Reg 2
  } else if (grepl("X4(.*?)G_S", colnames(my_data)[i])) {
    my_data[(nrow(my_data) - 2),i] <- "T_Transformed"
    my_data[(nrow(my_data) - 1), i] <- "LFY_Reg_2"
    my_data[(nrow(my_data)), i] <- "LFY_Reg2_Gall"
  } else if (grepl("X4(.*?)[^G]_S", colnames(my_data)[i])) {
    my_data[(nrow(my_data) - 2),i] <- "T_Transformed"
    my_data[(nrow(my_data) - 1), i] <- "LFY_Reg_2"
    my_data[(nrow(my_data)), i] <- "LFY_Reg2_NoGall"
  }  
  }
# Update rows with "metadata" on each sample's identity
...
setwd('/home/scott/Documents/Uni/Research/Projects/Grape_RNA_Seq_Expression_Analysis/EdgeR/Output/test/Project_1')
#-----------------------------------
...
Fish_Exact = exactTest(D, pair = c('GA3_CKC', 'GA3'))
...
# Write summary table
write.table(summary(simplified_DGE), file = 'GA3CKC_vs_GA3_Summary.txt', quote = F, sep = '\t')
...
write_tsv(Trans_v_Untrans_Wus_SBC_Direction, 'GA3CKC_vs_GA3_Direction.tsv')
...
# Clear workspace
#rm(Gene_Row_Key, D, D_Samples, Fish_Exact, my_grouping, Counts, topTags, GA3_Comparisons, simplified_DGE_frame)
```
...
D = estimateCommonDisp(D)
D = estimateTagwiseDisp(D)
Fish_Exact = exactTest(D, pair = c('GA3_CKC', 'CK'))
topTags = topTags(Fish_Exact)
...
# Write summary table
write.table(summary(simplified_DGE), file = 'GA3CKC_vs_CK_Summary.txt', quote = F, sep = '\t')
...
row.names(simplified_DGE_frame) = Gene_Row_Key$Gene
Trans_v_Untrans_Wus_SBC_Direction = as_tibble(rownames_to_column(simplified_DGE_frame, var = 'Gene_Name'))
write_tsv(Trans_v_Untrans_Wus_SBC_Direction, 'GA3CKC_vs_CK_Direction.tsv')
...
# Clear workspace
rm(Gene_Row_Key, D, D_Samples, Fish_Exact, my_grouping, Counts, topTags, CK_Comparisons, simplified_DGE_frame)
```
...
# Specify how to merge
Counts = merge(AUX_T, AUX_C, by = 'row.names')
rm(AUX_C, AUX_T)
...
D = estimateCommonDisp(D)
D = estimateTagwiseDisp(D)
Fish_Exact = exactTest(D, pair=c('AUXC', 'AUX'))
topTags = topTags(Fish_Exact)
...
# Write summary table
write.table(summary(simplified_DGE), file = 'AUXC_vs_AUX_Summary.txt', quote = F, sep = '\t')
...
row.names(simplified_DGE_frame) = Gene_Row_Key$Gene
Trans_v_Untrans_Wus_SBC_Direction = as_tibble(rownames_to_column(simplified_DGE_frame, var = 'Gene_Name'))
write_tsv(Trans_v_Untrans_Wus_SBC_Direction, 'AUXC_vs_AUX_Direction.tsv')
...
# Clear workspace
#rm(Gene_Row_Key, D, D_Samples, Fish_Exact, my_grouping, Counts, topTags, AUX_Comparisons, simplified_DGE_frame)
```
...
# Switch to output folder
setwd('/home/scott/Documents/Uni/Research/Projects/Grape_RNA_Seq_Expression_Analysis/EdgeR/Output/test/Project_2')
#-----------------------------------
...
rownames(Counts) <- Counts$Row.names
Counts = subset(Counts, select = -c(Row.names))
my_grouping = c(head(Counts, 1)) # transformed vs untransformed grouping declared


Counts = tail(Counts, -1) # drop Treatment row
...
D = estimateCommonDisp(D)
D = estimateTagwiseDisp(D)
Fish_Exact = exactTest(D, pair = c('SBC', 'WUS_Reg1_NoGall'))
topTags = topTags(Fish_Exact)
...
# Clear workspace
rm(Gene_Row_Key, D, D_Samples, Fish_Exact, my_grouping, Counts, topTags, WUS_Reg1_Comparisons, simplified_DGE_frame)
```
...
D = estimateCommonDisp(D)
D = estimateTagwiseDisp(D)
Fish_Exact = exactTest(D, pair = c('SBC', 'WUS_Reg2_NoGall'))
topTags = topTags(Fish_Exact)
...
# Clear workspace
rm(Gene_Row_Key, D, D_Samples, Fish_Exact, my_grouping, Counts, topTags, WUS_Reg2_Comparisons, simplified_DGE_frame)
```
...
D = estimateCommonDisp(D)
D = estimateTagwiseDisp(D)
Fish_Exact = exactTest(D, pair = c('SBC', 'LFY_Reg1_NoGall'))
topTags = topTags(Fish_Exact)
...
# Clear workspace
rm(Gene_Row_Key, D, D_Samples, Fish_Exact, my_grouping, Counts, topTags, LFY_Reg1_Comparisons, simplified_DGE_frame)
```
...
D = estimateCommonDisp(D)
D = estimateTagwiseDisp(D)
Fish_Exact = exactTest(D, pair = c('SBC', 'LFY_Reg2_NoGall'))
topTags = topTags(Fish_Exact)
...
# Clear workspace
rm(Gene_Row_Key, D, D_Samples, Fish_Exact, my_grouping, Counts, topTags, LFY_Reg2_Comparisons, simplified_DGE_frame)
```

## SBC vs DPR Comparisons
```{r SBC_DPR1, eval=TRUE}
Filtered_809 = Filter_809(input_data_809)
# Switch to output folder
setwd('/home/scott/Documents/Uni/Research/Projects/Grape_RNA_Seq_Expression_Analysis/EdgeR/Output/test/Project_2')
#-----------------------------------
SBC_vs_DPR_Comparisons_Function = function(Filtered_809) {
  # Subset the Data
  SB_C = select(Filtered_809, matches("SB\\.C[^K](.*?)_S"))
  DPR = select(Filtered_809, matches("DPR\\.1(.*?)G_S*"))
...
D = estimateCommonDisp(D)
D = estimateTagwiseDisp(D)
Fish_Exact = exactTest(D, pair = c('SBC', 'DPR1_Gall'))
topTags = topTags(Fish_Exact)
...
# Write summary table
write.table(summary(simplified_DGE), file = 'SBC_vs_DPR1_Gall_Summary.txt', quote = F, sep = '\t')
...
row.names(simplified_DGE_frame) = Gene_Row_Key$Gene
WUS_Reg1_NoGall_SBC_Direction = as_tibble(rownames_to_column(simplified_DGE_frame, var = 'Gene_Name'))
write_tsv(WUS_Reg1_NoGall_SBC_Direction, 'SBC_vs_DPR1_Gall_Direction.tsv')
...
# Clear workspace
rm(Gene_Row_Key, D, D_Samples, Fish_Exact, my_grouping, Counts, topTags, SBC_vs_DPR_Comparisons, simplified_DGE_frame)
```


## SBC vs DPR Comparisons
```{r SBC_DPR2, eval=TRUE}
Filtered_809 = Filter_809(input_data_809)
# Switch to output folder
setwd('/home/scott/Documents/Uni/Research/Projects/Grape_RNA_Seq_Expression_Analysis/EdgeR/Output/test/Project_2')
#-----------------------------------
SBC_vs_DPR_Comparisons_Function = function(Filtered_809) {
  # Subset the Data
  SB_C = select(Filtered_809, matches("SB\\.C[^K](.*?)_S"))
  DPR = select(Filtered_809, matches("DPR\\.2(.*?)G_S*"))
  SBC_vs_DPR_Comparisons = list(SB_C, DPR)
  # Return list of subsetted data
  return(SBC_vs_DPR_Comparisons)
}
...
D = estimateCommonDisp(D)
D = estimateTagwiseDisp(D)
Fish_Exact = exactTest(D, pair = c('SBC', 'DPR2_Gall'))
topTags = topTags(Fish_Exact)
...
# Write summary table
write.table(summary(simplified_DGE), file = 'SBC_vs_DPR2_Gall_Summary.txt', quote = F, sep = '\t')
...
row.names(simplified_DGE_frame) = Gene_Row_Key$Gene
WUS_Reg1_NoGall_SBC_Direction = as_tibble(rownames_to_column(simplified_DGE_frame, var = 'Gene_Name'))
write_tsv(WUS_Reg1_NoGall_SBC_Direction, 'SBC_vs_DPR2_Gall_Direction.tsv')
...
D = estimateCommonDisp(D)
D = estimateTagwiseDisp(D)
Fish_Exact = exactTest(D, pair = c('WC', 'AUXC'))
topTags = topTags(Fish_Exact)
...
# Clear workspace
rm(Gene_Row_Key, D, D_Samples, Fish_Exact, my_grouping, Counts, topTags, AUX_WC_Comparisons, simplified_DGE_frame)
```
...
D = estimateCommonDisp(D)
D = estimateTagwiseDisp(D)
Fish_Exact = exactTest(D, pair = c('WC', 'GA3_CKC'))
topTags = topTags(Fish_Exact)
...
# Clear workspace
rm(Gene_Row_Key, D, D_Samples, Fish_Exact, my_grouping, Counts, topTags, WC_GA3CK_Comparisons, simplified_DGE_frame)
```
...
D = estimateCommonDisp(D)
D = estimateTagwiseDisp(D)
Fish_Exact = exactTest(D, pair=c('SBC', 'SBCK'))
topTags = topTags(Fish_Exact)
...
# Clear workspace
rm(Gene_Row_Key, D, D_Samples, Fish_Exact, my_grouping, Counts, topTags, SBC_vs_SBCK_Comparisons, simplified_DGE_frame)
```
...
D = estimateCommonDisp(D)
D = estimateTagwiseDisp(D)
Fish_Exact = exactTest(D, pair=c("WUS_Reg1_NoGall", "WUS_Reg1_Gall"))
topTags = topTags(Fish_Exact)
...
# Write summary table
write.table(summary(simplified_DGE), file = 'WUS1NoGall_vs_WUS1G_Summary.txt', quote = F, sep = '\t')
...
row.names(simplified_DGE_frame) = Gene_Row_Key$Gene
WUS_Reg1_NoGall_SBC_Direction = as_tibble(rownames_to_column(simplified_DGE_frame, var = 'Gene_Name'))
write_tsv(WUS_Reg1_NoGall_SBC_Direction, 'WUS1NoGall_vs_WUS1G_Direction.tsv')

# Clear workspace
rm(Gene_Row_Key, D, D_Samples, Fish_Exact, my_grouping, Counts, topTags, WUS1_vs_WUS1G_Comparisons, simplified_DGE_frame)
```
...
D = estimateCommonDisp(D)
D = estimateTagwiseDisp(D)
Fish_Exact = exactTest(D, pair=c("LFY_Reg1_NoGall", "LFY_Reg1_Gall"))
topTags = topTags(Fish_Exact)
...
# Write summary table
write.table(summary(simplified_DGE), file = 'LFY1NoGall_vs_LFY1G_Summary.txt', quote = F, sep = '\t')
...
write_tsv(LFY1_LFY1G_Direction, 'LFY1NoGall_vs_LFY1G_Direction.tsv')

# Clear workspace
rm(Gene_Row_Key, D, D_Samples, Fish_Exact, my_grouping, Counts, topTags, LFY1_vs_LFY1G_Comparisons, simplified_DGE_frame)
```
...
D = estimateCommonDisp(D)
D = estimateTagwiseDisp(D)
Fish_Exact = exactTest(D, pair=c("LFY_Reg2_NoGall", "LFY_Reg2_Gall"))
topTags = topTags(Fish_Exact)
...
# Write summary table
write.table(summary(simplified_DGE), file = 'LFY2NoGall_vs_LFY2G_Summary.txt', quote = F, sep = '\t')
...
write_tsv(LFY2_LFY2G_Direction, 'LFY2NoGall_vs_LFY2G_Direction.tsv')

# Clear workspace
rm(Gene_Row_Key, D, D_Samples, Fish_Exact, my_grouping, Counts, topTags, LFY2_vs_LFY2G_Comparisons, simplified_DGE_frame)
```
...
# LFY1 and 2 Galls vs SBC
```{r LFY1_Gall, eval=TRUE}
Filtered_809 = Filter_809(input_data_809)
# Switch to output folder
setwd('/home/scott/Documents/Uni/Research/Projects/Grape_RNA_Seq_Expression_Analysis/EdgeR/Output/test/Project_2')
#-----------------------------------
LFY1_Gall_Comparisons_Function = function(Filtered_809) {
  # Subset the Data
  SB_C = select(Filtered_809, matches("SB\\.C[^K](.*?)_S"))
  LFY_Reg1_Gall =  select(Filtered_809, matches("X3(.*?)G_S"))
  LFY_Reg1_Comparisons = list(SB_C, LFY_Reg1_Gall)
  # Return list of subsetted data
  return(LFY_Reg1_Comparisons)
}
LFY_Reg1_Comparisons = LFY1_Gall_Comparisons_Function(Filtered_809)
SB_C = LFY_Reg1_Comparisons[[1]]
LFY_Reg1_Gall = LFY_Reg1_Comparisons[[2]]

# Specify how to merge
Counts = merge(SB_C, LFY_Reg1_Gall, by = 'row.names')
rm(SB_C, LFY_Reg1_Gall)
...
D = estimateCommonDisp(D)
D = estimateTagwiseDisp(D)
Fish_Exact = exactTest(D, pair = c('SBC', 'LFY_Reg1_Gall'))
topTags = topTags(Fish_Exact)
...
# Write summary table
write.table(summary(simplified_DGE), file = 'SBC_vs_LFY_Reg1_Gall_Summary.txt', quote = F, sep = '\t')
...
row.names(simplified_DGE_frame) = Gene_Row_Key$Gene
WUS_Reg1_NoGall_SBC_Direction = as_tibble(rownames_to_column(simplified_DGE_frame, var = 'Gene_Name'))
write_tsv(WUS_Reg1_NoGall_SBC_Direction, 'SBC_vs_LFY_Reg1_Gall_Direction.tsv')
...
# LFY1 and 2 Galls vs SBC
```{r LFY2_Gall, eval=TRUE}
Filtered_809 = Filter_809(input_data_809)
# Switch to output folder
setwd('/home/scott/Documents/Uni/Research/Projects/Grape_RNA_Seq_Expression_Analysis/EdgeR/Output/test/Project_2')
#-----------------------------------
LFY2_Gall_Comparisons_Function = function(Filtered_809) {
  # Subset the Data
  SB_C = select(Filtered_809, matches("SB\\.C[^K](.*?)_S"))
  LFY_Reg2_Gall =  select(Filtered_809, matches("X4(.*?)G_S"))
  LFY_Reg2_Comparisons = list(SB_C, LFY_Reg2_Gall)
  # Return list of subsetted data
  return(LFY_Reg2_Comparisons)
}
LFY_Reg2_Comparisons = LFY2_Gall_Comparisons_Function(Filtered_809)
SB_C = LFY_Reg2_Comparisons[[1]]
LFY_Reg2_Gall = LFY_Reg2_Comparisons[[2]]

# Specify how to merge
Counts = merge(SB_C, LFY_Reg2_Gall, by = 'row.names')
rm(SB_C, LFY_Reg2_Gall)
...
D = estimateCommonDisp(D)
D = estimateTagwiseDisp(D)
Fish_Exact = exactTest(D, pair = c('SBC', 'LFY_Reg2_Gall'))
topTags = topTags(Fish_Exact)
...
# Write summary table
write.table(summary(simplified_DGE), file = 'SBC_vs_LFY_Reg2_Gall_Summary.txt', quote = F, sep = '\t')
...
row.names(simplified_DGE_frame) = Gene_Row_Key$Gene
WUS_Reg1_NoGall_SBC_Direction = as_tibble(rownames_to_column(simplified_DGE_frame, var = 'Gene_Name'))
write_tsv(WUS_Reg1_NoGall_SBC_Direction, 'SBC_vs_LFY_Reg2_Gall_Direction.tsv')
...
## WUS1 vs SBC Comparisons
```{r WUS1_Gall, eval=TRUE}
Filtered_809 = Filter_809(input_data_809)
# Switch to output folder
setwd('/home/scott/Documents/Uni/Research/Projects/Grape_RNA_Seq_Expression_Analysis/EdgeR/Output/test/Project_2')
#-----------------------------------
WUS1_Gall_Comparisons_Function = function(Filtered_809) {
  # Subset the Data
  SB_C = select(Filtered_809, matches("SB\\.C[^K](.*?)_S"))
  WUS_Reg1_Gall =  select(Filtered_809, matches("X1(.*?)G_S"))
  WUS_Reg1_Comparisons = list(SB_C, WUS_Reg1_Gall)
  # Return list of subsetted data
  return(WUS_Reg1_Comparisons)
}
WUS_Reg1_Comparisons = WUS1_Gall_Comparisons_Function(Filtered_809)
SB_C = WUS_Reg1_Comparisons[[1]]
WUS_Reg1_Gall = WUS_Reg1_Comparisons[[2]]

# Specify how to merge
Counts = merge(SB_C, WUS_Reg1_Gall, by = 'row.names')
rm(SB_C, WUS_Reg1_Gall)
...
D = estimateCommonDisp(D)
D = estimateTagwiseDisp(D)
Fish_Exact = exactTest(D, pair = c('SBC', 'WUS_Reg1_Gall'))
topTags = topTags(Fish_Exact)
...
# Write summary table
write.table(summary(simplified_DGE), file = 'SBC_vs_WUS_Reg1_Gall_Summary.txt', quote = F, sep = '\t')
...
row.names(simplified_DGE_frame) = Gene_Row_Key$Gene
WUS_Reg1_NoGall_SBC_Direction = as_tibble(rownames_to_column(simplified_DGE_frame, var = 'Gene_Name'))
write_tsv(WUS_Reg1_NoGall_SBC_Direction, 'SBC_vs_WUS_Reg1_Gall_Direction.tsv')
