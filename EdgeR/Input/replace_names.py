...
# GFF_Data[["GSVIV_ID", "Nonsense_2"]] = GFF_Data.GSVIV_ID.str.split(
# ";pacid=", expand=True, n=1
# )


GFF_Data[["Nonsense_1", "GSVIV_ID"]] = GFF_Data.FullName.str.split(
    "Parent=", expand=True
)
GFF_Data[["Nonsense_1", "temp_pac"]] = GFF_Data.Nonsense_1.str.split("ID=", expand=True)
GFF_Data[["PAC_ID", "Nonsense_2"]] = GFF_Data.temp_pac.str.split(
    ";Name", expand=True, n=1
)
GFF_Data = GFF_Data.drop(["FullName", "Nonsense_1", "Nonsense_2", "temp_pac"], axis=1)
